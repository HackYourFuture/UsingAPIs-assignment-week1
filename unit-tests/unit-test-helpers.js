 ...
 * @returns {string} returns.source - The raw source code of the exercise file
 * @returns {*} [returns.module] - The dynamically imported module (if import was successful)
 * @returns {Object} [returns.rootNode] - The parsed AST root node (if parsing was successful)
